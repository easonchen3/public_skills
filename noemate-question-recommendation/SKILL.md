...
- `scripts/generate_eval_dataset.py`：根据种子评测集自动扩展出 100 到 200+ 条评测样本
...
python scripts/generate_eval_dataset.py --seed eval/recommendation_eval_seed_dataset.json --output eval/recommendation_eval_dataset.json
```
...
- `eval/recommendation_eval_seed_dataset.json`：人工整理的种子评测集
